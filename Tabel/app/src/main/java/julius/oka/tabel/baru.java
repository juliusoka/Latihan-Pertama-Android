...
public class baru extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        num_barang[1] = intent.getIntExtra("main.microwave",0);
        num_barang[2] = intent.getIntExtra("main.vacum.num",0);
        num_barang[3] = intent.getIntExtra("main.ac.num",0);
        num_barang[4] = intent.getIntExtra("main.camera.num",0);
        num_barang[5] = intent.getIntExtra("main.dvd.num",0);

        int [] harga_barang = new int[6];
        harga_barang[0]=3000000;
        harga_barang[1]=3000000;
        harga_barang[2]=3000000;
        harga_barang[3]=3000000;
        harga_barang[4]=3000000;
        harga_barang[5]=3000000;

        int [] id_num = {R.id.plasma2_num,R.id.microwave2_num,R.id.vacum2_num,R.id.ac2_num,R.id.camera2_num,R.id.dvd2_num};
        int[] id_total = {R.id.plasma2_total,R.id.microwave2_total,R.id.vacum2_total,R.id.ac2_total,R.id.camera2_total,R.id.dvd2_total};
