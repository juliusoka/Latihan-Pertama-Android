...
public class MainActivity extends AppCompatActivity {
    ...
    public void printreceipt(View view){
        ...
        barang[4] = ((EditText) findViewById(R.id.camera_num)).getText().toString();
        ...
        Intent intent = new Intent(this, baru.class);
        intent.putExtra("main.plasma.num", num_barang[0]);
        intent.putExtra("main.microwave", num_barang[1]);
        intent.putExtra("main.vacum.num", num_barang[2]);
        intent.putExtra("main.ac.num", num_barang[3]);
        intent.putExtra("main.camera.num", num_barang[4]);
